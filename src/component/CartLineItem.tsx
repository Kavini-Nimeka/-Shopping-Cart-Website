...
const onRemoveFromCart = () =>
  ...
  const content = (
    <li className="cart__item">
        ...
        <div aria-label="Price Per Item">{new Intl.NumberFormat('en-SL', {style: 'currency', currency: 'LKR'}).format(item.price)}</div>
        ...
        {new Intl.NumberFormat('en-SL', {style: 'currency', currency: 'LKR'}).format(lineTotal)}  
